...
#TestClusterGKEStatus: {
	conditions?: [...#TestClusterGKEStatusCondition] @go(Conditions,[]TestClusterGKEStatusCondition)
	endpoint?:             null | string @go(Endpoint,*string)
	operation?:            null | string @go(Operation,*string)
	kubeconfigSecretName?: null | string @go(KubeconfigSecretName,*string)
	clusterName?:          null | string @go(ClusterName,*string)
}

#TestClusterGKEStatusCondition: {
	type:                string       @go(Type)
